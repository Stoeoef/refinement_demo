...
* @param {number} width
* @param {number} height
* @param {number} min_allowed_angle_limit
* @param {boolean} do_refine
* @param {boolean} keep_constraint_edges
* @param {number} max_additional_vertices
* @param {number} min_face_area
* @param {number} max_face_area
*/
__exports.draw = function(width, height, min_allowed_angle_limit, do_refine, keep_constraint_edges, max_additional_vertices, min_face_area, max_face_area) {
    wasm.draw(width, height, min_allowed_angle_limit, do_refine, keep_constraint_edges, max_additional_vertices, min_face_area, max_face_area);
};
...
async function init(input) {
    ...
    imports.wbg.__wbg_resetTransform_39d2ab7734ed0fc6 = function() { return handleError(function (arg0) {
